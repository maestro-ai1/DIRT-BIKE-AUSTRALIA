      ...
      <div className="max-w-md mx-auto px-4 w-full bg-white p-8 sm:p-12 rounded-3xl border border-slate-200/90 shadow-xl text-center space-y-6">
        ...
        <div className="space-y-2">
          <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">
            Wholesale Application Logged
          </h1>
          <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
            Thank you for your interest in partnering with Electric Dirt Bike Australia. Our commercial dealer director will review your dealership details and reach out with pricing schedules.
          </p>
        </div>
        <Link
          href="/"
